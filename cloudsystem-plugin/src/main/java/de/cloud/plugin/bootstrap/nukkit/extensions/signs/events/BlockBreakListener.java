        ...
        if (CloudSignsProvider.getRegisterSigns().containsKey(player.getName())) {
            if (block instanceof BlockSignPost) {
                ...
                if (CloudSignsProvider.isCloudSign(block)) {
                    player.sendMessage(CloudSigns.getPrefix() + "§cThis sign is already in use.");
                    return;
                }
                ...
                player.sendMessage(CloudSigns.getPrefix() + "§aCloudSign was registered successfully.");
            }
            ...
            if (block instanceof BlockSignPost) {
                ...
                if (!CloudSignsProvider.isCloudSign(block)) {
                    player.sendMessage(CloudSigns.getPrefix() + "§cThis sign is NOT a cloud sign.");
                    return;
                }
                ...
                player.sendMessage(CloudSigns.getPrefix() + "§aYou have removed this cloud sign.");
            }
            ...
            if (block instanceof BlockSignPost) {
                ...
                player.sendMessage(CloudSigns.getPrefix()
